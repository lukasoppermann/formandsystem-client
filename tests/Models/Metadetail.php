...
class Metadetail extends BaseModel
{
    ...
    {
        return $this->relationshipTrashedFilter($this->morphedByMany('Tests\Models\Page', 'metadetailable'));
    }
    /**
     * The pages that belong to the fragment.
     */
    ...
    {
        return $this->relationshipTrashedFilter($this->morphedByMany('Tests\Models\Fragment', 'metadetailable'));
    }
    /**
    ...
    {
        return $this->relationshipTrashedFilter($this->morphedByMany('Tests\Models\Image', 'metadetailable'));
    }
}
